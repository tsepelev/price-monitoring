...
def search_products(query, location="Moscow", language="ru", country="ru"):
    """
...
def index():
    ...
    result = search_products(query, location) if query else ""
    
    return render_template("index.html", content=result, query=query)
